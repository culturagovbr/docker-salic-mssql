INSERT INTO SAC.dbo.tbTipoEncaminhamento (idTipoEncaminhamento,dsEncaminhamento) VALUES 
(0,'Desistência do prazo recursal encaminhada pelo proponente ao MinC ')
...
,(13,'Solicitação indeferida e encaminhada para arquivamento')
,(14,'Solicitação encaminhada a unidade de análise pela CNIC ')
,(15,'Solicitação finalizada pelo MinC')
,(16,'Solicitação devolvida ao Proponente para ajustes')
